...
export function optional<T>(validate: Validator<T>): (data: unknown) => T | undefined {
  return (data: unknown): T | undefined => (data === undefined ? undefined : validate(data))
}
